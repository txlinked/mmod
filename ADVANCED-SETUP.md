...
Caller elapsed time uses seconds, minutes, then whole hours. Current caller details clear after 24 hours; the two slot placeholders remain. Activity independently keeps only the latest 15 calls, newest first, without a time-based expiry. Radio logs are retained.
